...
const ICON_OPTIONS = [
  { value: '📦', label: 'Box' },
  { value: '🧊', label: 'Ice Cube (Fridge)' },
  { value: '❄️', label: 'Snowflake (Freezer)' },
  { value: '🏠', label: 'House' },
  { value: '🚪', label: 'Door' },
  { value: '🪜', label: 'Ladder (Attic)' },
  { value: '🔽', label: 'Down Arrow (Basement)' },
  { value: '🚗', label: 'Car (Garage)' },
  { value: '🍽️', label: 'Plate (Dining)' },
  { value: '🗄️', label: 'File Cabinet' },
  { value: '📚', label: 'Books (Shelf)' },
  { value: '🧰', label: 'Toolbox' },
  { value: '🎒', label: 'Backpack' },
  { value: '👜', label: 'Handbag' },
  { value: '🧺', label: 'Basket' },
  { value: '🗃️', label: 'Storage Box' },
];
